    ...
    <section className="Contactblock" id={props.id} style={StyleBackground}>
      <div class="container">
        <Row>
          <Col md={6}>
            <h2>
              <span className="partA">{props.titlePartA[lang]}</span>
              <br />
              <span className="partB">{props.titlePartB[lang]}</span>
              <span className="partC">{props.titlePartC[lang]}</span>
              <br />
          ...
          <Col md={6}>
            <form className="contact-form" id="myform" onSubmit={formik.handleSubmit}>
              <Form.Group>
                <Form.Control type="hidden" name="to" id="to" value="info@2centric.com" />
              </Form.Group>
              <Form.Group>
                <Form.Control
                  type="hidden"
              ...
              <Row>
                <Col md={12}>
                  <div style={{ textAlign: "left", marginTop: "50px" }}>
                    <button type="submit" className="Btnformmail">
                      {" "}
                      SUBMIT FORM
                    </button>
                  </div>
